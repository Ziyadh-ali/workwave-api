...
export class AdminUserManagement {
  ...
  async addUser(req: Request, res: Response): Promise<void> {
    ...
    res
      ...
      .json({ response, message: MESSAGES.SUCCESS.USER_CREATED });
  }
  ...
  async getUsers(req: Request, res: Response): Promise<void> {
    ...
    const filter: EmployeeFilter = {
      role: role !== "all" ? toStringOrUndefined(role as string | ParsedQs | string[] | ParsedQs[] | undefined) : undefined,
      status:
        status !== "all"
          ? (toStringOrUndefined(status as string | ParsedQs | string[] | ParsedQs[] | undefined) as "active" | "inactive" | undefined)
          : undefined,
      department:
        department !== "all" ? toStringOrUndefined(department as string | ParsedQs | string[] | ParsedQs[] | undefined) : undefined,
      fullName: search
        ? { $regex: toStringOrUndefined(search as string | ParsedQs | string[] | ParsedQs[] | undefined) ?? "", $options: "i" }
        : undefined,
    };
